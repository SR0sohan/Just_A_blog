          ...
          <div class="login-wrapper my-auto">
            ...
            <?php
             if(isset($_POST['login'])){
                ...
                if(empty($email)){
                  echo "<span class='alert alert-danger'>email field cannot be empty!</span>";
                }
                if(empty($password)){
                  echo "<span class='alert alert-danger'>password field cannot be empty!</span>";
                }
                if(!empty($email) && !empty($password)){
                  ...
                  $loginResult = mysqli_query($db,$loginQuery);
                   ...
                   if($email == $_SESSION['u_email'] && $hassPassword ==$u_pass && ($_SESSION['u_role'] =='1' || $_SESSION['u_role'] == '2')){
                     header('location:dashboard.php');
                   }
